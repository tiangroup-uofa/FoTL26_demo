---
title: "Bridging Theory and Practice with AI"
subtitle: "Interactive Learning in Highly Theoretical Courses With Modern Coding Tools"
author: "Dr. Tian Tian (FoE)"
institute: "Department of Chemical and Materials Engineering, University of Alberta"
date: "2026-04-28"
format:
  html: {}
  revealjs:
...
- How can the students understand the "power" with these equations, if we cannot easily show what the equations do?
...
- **Inclusiveness**: Students focus on physics and transport phenomena, and minimal software setup.

- **Diversity**: Students can engage at different levels -- interact with the UI; explore  the code; modify the code!
...
## Students Testaments (Midterm SPOT Survey)
